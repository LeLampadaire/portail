<?php session_start();
    ...
    if($IdPseudo != NULL){
        if(!empty($_POST['confirmation-enutrosor'])){
            ...
            mysqli_query($bdd, 'INSERT INTO rubilax_cpt(id, id_pos, id_membre, validation) VALUES(NULL, '.$_POST['confirmation-enutrosor'].', '.$IdPseudo.', 1);');
            ...
            mysqli_query($bdd, 'INSERT INTO rubilax_cpt(id, id_pos, id_membre, validation) VALUES(NULL, '.$_POST['report-enutrosor'].', '.$IdPseudo.', 0);');
        }else if(!empty($_POST['valid-enutrosor'])){
            if($_POST['utilisation-enutrosor'] == 0){
                mysqli_query($bdd, 'UPDATE rubilax SET utilisation='.$_POST['utilisation-enutrosor'].', positionX=NULL, positionY=NULL, modificateur=NULL, id_membre='.$IdPseudo.' WHERE id='.$_POST['valid-enutrosor'].';');
            }else{
                $recup = mysqli_query($bdd, 'SELECT positionX, positionY FROM rubilax WHERE id='.$_POST['valid-enutrosor'].';');
                ...
                if($_POST['positionY-enutrosor'] == $recup['positionY'] AND $_POST['positionX-enutrosor'] == $recup['positionX']){
                    mysqli_query($bdd, 'UPDATE rubilax SET utilisation='.$_POST['utilisation-enutrosor'].', modificateur="'.$_POST['modificateur-enutrosor'].'" WHERE id='.$_POST['valid-enutrosor'].';');
                    if($_POST['modificateur-enutrosor'] == "NULL"){
                        mysqli_query($bdd, 'UPDATE rubilax SET modificateur=NULL WHERE id='.$_POST['valid-enutrosor'].';');
                    }
                }else{
                    mysqli_query($bdd, 'INSERT INTO rubilax (id, portail, positionX, positionY, utilisation, modificateur, id_membre, temps) VALUES (NULL, "enutrosor", '.$_POST['positionX-enutrosor'].', '.$_POST['positionY-enutrosor'].', '.$_POST['utilisation-enutrosor'].', "'.$_POST['modificateur-enutrosor'].'", '.$IdPseudo.', CURRENT_TIMESTAMP());');
                    if($_POST['modificateur-enutrosor'] == "NULL"){
                        $tid = mysqli_query($bdd, 'SELECT id FROM rubilax WHERE id=(SELECT MAX(id) FROM rubilax) AND portail="enutrosor";');
                        $tid = mysqli_fetch_array($tid, MYSQLI_ASSOC);
                        mysqli_query($bdd, 'UPDATE rubilax SET modificateur=NULL WHERE id='.$tid['id'].';');
                    }
                }
            }
        }else if(!empty($_POST['inconnu-enutrosor'])){
            mysqli_query($bdd, 'UPDATE rubilax SET utilisation=0, positionX=NULL, positionY=NULL, modificateur=NULL, id_membre='.$IdPseudo.' WHERE id='.$_POST['inconnu-enutrosor'].';');
        }else if(!empty($_POST['confirmation-srambad'])){
            mysqli_query($bdd, 'UPDATE membres SET validation_totale = validation_totale+1 WHERE id='.$_POST['id_membre'].';');
            mysqli_query($bdd, 'INSERT INTO rubilax_cpt(id, id_pos, id_membre, validation) VALUES(NULL, '.$_POST['confirmation-srambad'].', '.$IdPseudo.', 1);');
        }else if(!empty($_POST['report-srambad'])){
            mysqli_query($bdd, 'UPDATE membres SET report_totale = report_totale+1 WHERE id='.$_POST['id_membre'].';');
            mysqli_query($bdd, 'INSERT INTO rubilax_cpt(id, id_pos, id_membre, validation) VALUES(NULL, '.$_POST['report-srambad'].', '.$IdPseudo.', 0);');
        }else if(!empty($_POST['valid-srambad'])){
            if($_POST['utilisation-srambad'] == 0){
                mysqli_query($bdd, 'UPDATE rubilax SET utilisation='.$_POST['utilisation-srambad'].', positionX=NULL, positionY=NULL, modificateur=NULL, id_membre='.$IdPseudo.' WHERE id='.$_POST['valid-srambad'].';');
            }else{
                $recup = mysqli_query($bdd, 'SELECT positionX, positionY FROM rubilax WHERE id='.$_POST['valid-srambad'].';');
                $recup = mysqli_fetch_array($recup, MYSQLI_ASSOC);
                if($_POST['positionY-srambad'] == $recup['positionY'] AND $_POST['positionX-srambad'] == $recup['positionX']){
                    mysqli_query($bdd, 'UPDATE rubilax SET utilisation='.$_POST['utilisation-srambad'].', modificateur="'.$_POST['modificateur-srambad'].'" WHERE id='.$_POST['valid-srambad'].';');
                    if($_POST['modificateur-srambad'] == "NULL"){
                        mysqli_query($bdd, 'UPDATE rubilax SET modificateur=NULL WHERE id='.$_POST['valid-srambad'].';');
                    }
                }else{
                    mysqli_query($bdd, 'INSERT INTO rubilax (id, portail, positionX, positionY, utilisation, modificateur, id_membre, temps) VALUES (NULL, "srambad", '.$_POST['positionX-srambad'].', '.$_POST['positionY-srambad'].', '.$_POST['utilisation-srambad'].', "'.$_POST['modificateur-srambad'].'", '.$IdPseudo.', CURRENT_TIMESTAMP());');
                    if($_POST['modificateur-srambad'] == "NULL"){
                        $tid = mysqli_query($bdd, 'SELECT id FROM rubilax WHERE id=(SELECT MAX(id) FROM rubilax) AND portail="srambad";');
                        $tid = mysqli_fetch_array($tid, MYSQLI_ASSOC);
                        mysqli_query($bdd, 'UPDATE rubilax SET modificateur=NULL WHERE id='.$tid['id'].';');
                    }
                }
            ...
            mysqli_query($bdd, 'UPDATE rubilax SET utilisation=0, positionX=NULL, positionY=NULL, modificateur=NULL, id_membre='.$IdPseudo.' WHERE id='.$_POST['inconnu-srambad'].';');
        }else if(!empty($_POST['confirmation-xelorium'])){
            mysqli_query($bdd, 'UPDATE membres SET validation_totale = validation_totale+1 WHERE id='.$_POST['id_membre'].';');
            mysqli_query($bdd, 'INSERT INTO rubilax_cpt(id, id_pos, id_membre, validation) VALUES(NULL, '.$_POST['confirmation-xelorium'].', '.$IdPseudo.', 1);');
        }else if(!empty($_POST['report-xelorium'])){
            mysqli_query($bdd, 'UPDATE membres SET report_totale = report_totale+1 WHERE id='.$_POST['id_membre'].';');
            mysqli_query($bdd, 'INSERT INTO rubilax_cpt(id, id_pos, id_membre, validation) VALUES(NULL, '.$_POST['report-xelorium'].', '.$IdPseudo.', 0);');
        }else if(!empty($_POST['valid-xelorium'])){
            if($_POST['utilisation-xelorium'] == 0){
                mysqli_query($bdd, 'UPDATE rubilax SET utilisation='.$_POST['utilisation-xelorium'].', positionX=NULL, positionY=NULL, modificateur=NULL, id_membre='.$IdPseudo.' WHERE id='.$_POST['valid-xelorium'].';');
            }else{
                $recup = mysqli_query($bdd, 'SELECT positionX, positionY FROM rubilax WHERE id='.$_POST['valid-xelorium'].';');
                $recup = mysqli_fetch_array($recup, MYSQLI_ASSOC);
                if($_POST['positionY-xelorium'] == $recup['positionY'] AND $_POST['positionX-xelorium'] == $recup['positionX']){
                    mysqli_query($bdd, 'UPDATE rubilax SET utilisation='.$_POST['utilisation-xelorium'].', modificateur="'.$_POST['modificateur-xelorium'].'" WHERE id='.$_POST['valid-xelorium'].';');
                    if($_POST['modificateur-xelorium'] == "NULL"){
                        mysqli_query($bdd, 'UPDATE rubilax SET modificateur=NULL WHERE id='.$_POST['valid-xelorium'].';');
                    }
                }else{
                    mysqli_query($bdd, 'INSERT INTO rubilax (id, portail, positionX, positionY, utilisation, modificateur, id_membre, temps) VALUES (NULL, "xelorium", '.$_POST['positionX-xelorium'].', '.$_POST['positionY-xelorium'].', '.$_POST['utilisation-xelorium'].', "'.$_POST['modificateur-xelorium'].'", '.$IdPseudo.', CURRENT_TIMESTAMP());');
                    if($_POST['modificateur-xelorium'] == "NULL"){
                        $tid = mysqli_query($bdd, 'SELECT id FROM rubilax WHERE id=(SELECT MAX(id) FROM rubilax) AND portail="xelorium";');
                        $tid = mysqli_fetch_array($tid, MYSQLI_ASSOC);
                        mysqli_query($bdd, 'UPDATE rubilax SET modificateur=NULL WHERE id='.$tid['id'].';');
                    }
                }
            ...
            mysqli_query($bdd, 'UPDATE rubilax SET utilisation=0, positionX=NULL, positionY=NULL, modificateur=NULL, id_membre='.$IdPseudo.' WHERE id='.$_POST['inconnu-xelorium'].';');
        }else if(!empty($_POST['confirmation-ecaflipus'])){
            mysqli_query($bdd, 'UPDATE membres SET validation_totale = validation_totale+1 WHERE id='.$_POST['id_membre'].';');
            mysqli_query($bdd, 'INSERT INTO rubilax_cpt(id, id_pos, id_membre, validation) VALUES(NULL, '.$_POST['confirmation-ecaflipus'].', '.$IdPseudo.', 1);');
        }else if(!empty($_POST['report-ecaflipus'])){
            mysqli_query($bdd, 'UPDATE membres SET report_totale = report_totale+1 WHERE id='.$_POST['id_membre'].';');
            mysqli_query($bdd, 'INSERT INTO rubilax_cpt(id, id_pos, id_membre, validation) VALUES(NULL, '.$_POST['report-ecaflipus'].', '.$IdPseudo.', 0);');
        }else if(!empty($_POST['valid-ecaflipus'])){
            if($_POST['utilisation-ecaflipus'] == 0){
                mysqli_query($bdd, 'UPDATE rubilax SET utilisation='.$_POST['utilisation-ecaflipus'].', positionX=NULL, positionY=NULL, modificateur=NULL, id_membre='.$IdPseudo.' WHERE id='.$_POST['valid-ecaflipus'].';');
            }else{
                $recup = mysqli_query($bdd, 'SELECT positionX, positionY FROM rubilax WHERE id='.$_POST['valid-ecaflipus'].';');
                $recup = mysqli_fetch_array($recup, MYSQLI_ASSOC);
                if($_POST['positionY-ecaflipus'] == $recup['positionY'] AND $_POST['positionX-ecaflipus'] == $recup['positionX']){
                    mysqli_query($bdd, 'UPDATE rubilax SET utilisation='.$_POST['utilisation-ecaflipus'].', modificateur="'.$_POST['modificateur-ecaflipus'].'" WHERE id='.$_POST['valid-ecaflipus'].';');
                    if($_POST['modificateur-ecaflipus'] == "NULL"){
                        mysqli_query($bdd, 'UPDATE rubilax SET modificateur=NULL WHERE id='.$_POST['valid-ecaflipus'].';');
                    }
                }else{
                    mysqli_query($bdd, 'INSERT INTO rubilax (id, portail, positionX, positionY, utilisation, modificateur, id_membre, temps) VALUES (NULL, "ecaflipus", '.$_POST['positionX-ecaflipus'].', '.$_POST['positionY-ecaflipus'].', '.$_POST['utilisation-ecaflipus'].', "'.$_POST['modificateur-ecaflipus'].'", '.$IdPseudo.', CURRENT_TIMESTAMP());');
                    if($_POST['modificateur-ecaflipus'] == "NULL"){
                        $tid = mysqli_query($bdd, 'SELECT id FROM rubilax WHERE id=(SELECT MAX(id) FROM rubilax) AND portail="ecaflipus";');
                        $tid = mysqli_fetch_array($tid, MYSQLI_ASSOC);
                        mysqli_query($bdd, 'UPDATE rubilax SET modificateur=NULL WHERE id='.$tid['id'].';');
                    }
                }
            ...
            mysqli_query($bdd, 'UPDATE rubilax SET utilisation=0, positionX=NULL, positionY=NULL, modificateur=NULL, id_membre='.$IdPseudo.' WHERE id='.$_POST['inconnu-ecaflipus'].';');
        }
    }
...
<body>
    ...
    <div class="container">
        <h1 class="display-3 text-center text-white-position Forte">Rubilax</h1>
        ...
        <div class="col-lg-12">
            <div class="row">
                ...
                <h4>Actuellement :</h4>
                    ...
                    <?php 
                        $enutrosor = mysqli_query($bdd, 'SELECT rubilax.id as id_rubilax, pseudo, positionX, positionY, utilisation, modificateur, id_membre, TIMESTAMPDIFF(MINUTE,temps,NOW()) as temps FROM rubilax INNER JOIN membres ON(rubilax.id_membre = membres.id) WHERE portail="enutrosor" ORDER BY rubilax.id DESC');
                ...
                <div class="col-lg-3">
                    <?php 
                        if($enutrosor['id_rubilax'] != NULL){
                            $test_valid = mysqli_query($bdd, 'SELECT COUNT(validation) as nbr FROM rubilax_cpt WHERE id_pos='.$enutrosor['id_rubilax'].' AND validation=1;');
                            $test_valid = mysqli_fetch_array($test_valid, MYSQLI_ASSOC);
                            $test_report = mysqli_query($bdd, 'SELECT COUNT(validation) as nbr FROM rubilax_cpt WHERE id_pos='.$enutrosor['id_rubilax'].' AND validation=0;');
                    ...
                    <?php if($session == 1){
                        if($enutrosor['id_rubilax'] != NULL){
                            $droit = mysqli_query($bdd, 'SELECT * FROM rubilax_cpt WHERE id_pos='.$enutrosor['id_rubilax'].' AND id_membre='.$IdPseudo.';');
                        ...
                        if(!$droit){ ?>
                            <form action="" method="POST">
                                ...
                                <button type="submit" class="btn btn-success EcartPosRep" name="confirmation-enutrosor" value="<?php echo $enutrosor['id_rubilax']; ?>" <?php if($disabled){ echo 'disabled'; } ?>>Confirmer la position</button>
                                <button type="submit" class="btn btn-danger" name="report-enutrosor" value="<?php echo $enutrosor['id_rubilax']; ?>" <?php if($disabled){ echo 'disabled'; } ?>>Report !</button>
                            </form><br>
                        <?php } 
                    } ?>
                </div>
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            <div class="col-lg-6 btn-group BTNmilieu">
                                <button type="submit" class="btn btn-success" name="valid-enutrosor" value="<?php if($enutrosor['id_rubilax'] != NULL){ echo $enutrosor['id_rubilax']; }else{ echo '-1'; }?>" <?php if($session == 0){ echo 'disabled'; } ?>>Validez la position !</button>
                            </div>
                            <div class="col-lg-6 btn-group BTNmilieu">
                                ...
                                <div class="modal fade" id="PositionInconnueEnutrosor" tabindex="-1" role="dialog" aria-labelledby="PositionInconnueEnutrosorTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form action="" method="POST">
                                                    <button type="submit" class="btn btn-primary" name="inconnu-enutrosor" value="<?php echo $enutrosor['id_rubilax']; ?>" <?php if($session == 0){ echo 'disabled'; } ?>>Je suis sûr !</button>
                                                </form>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <h4>Actuellement :</h4>
                        <p class="text-center espace10pxBot">
                        <?php 
                            $srambad = mysqli_query($bdd, 'SELECT rubilax.id as id_rubilax, pseudo, positionX, positionY, utilisation, modificateur, id_membre, TIMESTAMPDIFF(MINUTE,temps,NOW()) as temps FROM rubilax INNER JOIN membres ON(rubilax.id_membre = membres.id) WHERE portail="srambad" ORDER BY rubilax.id DESC');
                    ...
                    <div class="col-lg-3">
                        <?php 
                            if($srambad['id_rubilax'] != NULL){
                                $test_valid = mysqli_query($bdd, 'SELECT COUNT(validation) as nbr FROM rubilax_cpt WHERE id_pos='.$srambad['id_rubilax'].' AND validation=1;');
                                $test_valid = mysqli_fetch_array($test_valid, MYSQLI_ASSOC);
                                $test_report = mysqli_query($bdd, 'SELECT COUNT(validation) as nbr FROM rubilax_cpt WHERE id_pos='.$srambad['id_rubilax'].' AND validation=0;');
                                $test_report = mysqli_fetch_array($test_report, MYSQLI_ASSOC);
                                $disabled = 0;
                            }else{
                                $test_valid['validation'] = 0;
                        ...
                        <?php if($session == 1){
                            if($srambad['id_rubilax'] != NULL){
                                $droit = mysqli_query($bdd, 'SELECT * FROM rubilax_cpt WHERE id_pos='.$srambad['id_rubilax'].' AND id_membre='.$IdPseudo.';');
                                $droit = mysqli_fetch_array($droit, MYSQLI_ASSOC);
                            }else{
                                $droit = 1;
                            }
                            ...
                            if(!$droit){ ?>
                                <form action="" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-success EcartPosRep" name="confirmation-srambad" value="<?php echo $srambad['id_rubilax']; ?>" <?php if($disabled){ echo 'disabled'; } ?>>Confirmer la position</button>
                                    <button type="submit" class="btn btn-danger" name="report-srambad" value="<?php echo $srambad['id_rubilax']; ?>" <?php if($disabled){ echo 'disabled'; } ?>>Report !</button>
                                </form><br>
                            <?php } 
                        } ?>
                    </div>
                    ...
                    <div class="col-lg-5">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                <div class="col-lg-6 btn-group BTNmilieu">
                                    <button type="submit" class="btn btn-success" name="valid-srambad" value="<?php if($srambad['id_rubilax'] != NULL){ echo $srambad['id_rubilax']; }else{ echo '-1'; }?>" <?php if($session == 0){ echo 'disabled'; } ?>>Validez la position !</button>
                                </div>
                                <div class="col-lg-6 btn-group BTNmilieu">
                                    ...
                                    <div class="modal fade" id="PositionInconnueSrambad" tabindex="-1" role="dialog" aria-labelledby="PositionInconnueSrambadTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="" method="POST">
                                                        <button type="submit" class="btn btn-primary" name="inconnu-srambad" value="<?php echo $srambad['id_rubilax']; ?>" <?php if($session == 0){ echo 'disabled'; } ?>>Je suis sûr !</button>
                                                    </form>
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
                                                </div>
                                            </div>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <h4>Actuellement :</h4>
                        <p class="text-center espace10pxBot">
                        <?php 
                            $xelorium = mysqli_query($bdd, 'SELECT rubilax.id as id_rubilax, pseudo, positionX, positionY, utilisation, modificateur, id_membre, TIMESTAMPDIFF(MINUTE,temps,NOW()) as temps FROM rubilax INNER JOIN membres ON(rubilax.id_membre = membres.id) WHERE portail="xelorium" ORDER BY rubilax.id DESC');
                    ...
                    <div class="col-lg-3">
                        <?php 
                            if($xelorium['id_rubilax'] != NULL){
                                $test_valid = mysqli_query($bdd, 'SELECT COUNT(validation) as nbr FROM rubilax_cpt WHERE id_pos='.$xelorium['id_rubilax'].' AND validation=1;');
                                $test_valid = mysqli_fetch_array($test_valid, MYSQLI_ASSOC);
                                $test_report = mysqli_query($bdd, 'SELECT COUNT(validation) as nbr FROM rubilax_cpt WHERE id_pos='.$xelorium['id_rubilax'].' AND validation=0;');
                                $test_report = mysqli_fetch_array($test_report, MYSQLI_ASSOC);
                                $disabled = 0;
                            }else{
                                $test_valid['validation'] = 0;
                        ...
                        <?php if($session == 1){
                            if($xelorium['id_rubilax'] != NULL){
                                $droit = mysqli_query($bdd, 'SELECT * FROM rubilax_cpt WHERE id_pos='.$xelorium['id_rubilax'].' AND id_membre='.$IdPseudo.';');
                                $droit = mysqli_fetch_array($droit, MYSQLI_ASSOC);
                            }else{
                                $droit = 1;
                            }
                            ...
                            if(!$droit){ ?>
                                <form action="" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-success EcartPosRep" name="confirmation-xelorium" value="<?php echo $xelorium['id_rubilax']; ?>" <?php if($disabled){ echo 'disabled'; } ?>>Confirmer la position</button>
                                    <button type="submit" class="btn btn-danger" name="report-xelorium" value="<?php echo $xelorium['id_rubilax']; ?>" <?php if($disabled){ echo 'disabled'; } ?>>Report !</button>
                                </form><br>
                            <?php } 
                        } ?>
                    </div>
                    ...
                    <div class="col-lg-5">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                <div class="col-lg-6 btn-group BTNmilieu">
                                    <button type="submit" class="btn btn-success" name="valid-xelorium" value="<?php if($xelorium['id_rubilax'] != NULL){ echo $xelorium['id_rubilax']; }else{ echo '-1'; }?>" <?php if($session == 0){ echo 'disabled'; } ?>>Validez la position !</button>
                                </div>
                                <div class="col-lg-6 btn-group BTNmilieu">
                                    ...
                                    <div class="modal fade" id="PositionInconnueXelorium" tabindex="-1" role="dialog" aria-labelledby="PositionInconnueXeloriumTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="" method="POST">
                                                        <button type="submit" class="btn btn-primary" name="inconnu-xelorium" value="<?php echo $xelorium['id_rubilax']; ?>" <?php if($session == 0){ echo 'disabled'; } ?>>Je suis sûr !</button>
                                                    </form>
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
                                                </div>
                                            </div>
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <h4>Actuellement :</h4>
                        <p class="text-center espace10pxBot">
                        <?php 
                            $ecaflipus = mysqli_query($bdd, 'SELECT rubilax.id as id_rubilax, pseudo, positionX, positionY, utilisation, modificateur, id_membre, TIMESTAMPDIFF(MINUTE,temps,NOW()) as temps FROM rubilax INNER JOIN membres ON(rubilax.id_membre = membres.id) WHERE portail="ecaflipus" ORDER BY rubilax.id DESC');
                    ...
                    <div class="col-lg-3">
                        <?php 
                            if($ecaflipus['id_rubilax'] != NULL){
                                $test_valid = mysqli_query($bdd, 'SELECT COUNT(validation) as nbr FROM rubilax_cpt WHERE id_pos='.$ecaflipus['id_rubilax'].' AND validation=1;');
                                $test_valid = mysqli_fetch_array($test_valid, MYSQLI_ASSOC);
                                $test_report = mysqli_query($bdd, 'SELECT COUNT(validation) as nbr FROM rubilax_cpt WHERE id_pos='.$ecaflipus['id_rubilax'].' AND validation=0;');
                                $test_report = mysqli_fetch_array($test_report, MYSQLI_ASSOC);
                                $disabled = 0;
                            }else{
                                $test_valid['validation'] = 0;
                        ...
                        <?php if($session == 1){
                            if($ecaflipus['id_rubilax'] != NULL){
                                $droit = mysqli_query($bdd, 'SELECT * FROM rubilax_cpt WHERE id_pos='.$ecaflipus['id_rubilax'].' AND id_membre='.$IdPseudo.';');
                                $droit = mysqli_fetch_array($droit, MYSQLI_ASSOC);
                            }else{
                                $droit = 1;
                            }
                            ...
                            if(!$droit){ ?>
                                <form action="" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-success EcartPosRep" name="confirmation-ecaflipus" value="<?php echo $ecaflipus['id_rubilax']; ?>" <?php if($disabled){ echo 'disabled'; } ?>>Confirmer la position</button>
                                    <button type="submit" class="btn btn-danger" name="report-ecaflipus" value="<?php echo $ecaflipus['id_rubilax']; ?>" <?php if($disabled){ echo 'disabled'; } ?>>Report !</button>
                                </form><br>
                            <?php } 
                        } ?>
                    </div>
                    ...
                    <div class="col-lg-5">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                <div class="col-lg-6 btn-group BTNmilieu">
                                    <button type="submit" class="btn btn-success" name="valid-ecaflipus" value="<?php if($ecaflipus['id_rubilax'] != NULL){ echo $ecaflipus['id_rubilax']; }else{ echo '-1'; }?>" <?php if($session == 0){ echo 'disabled'; } ?>>Validez la position !</button>
                                </div>
                                <div class="col-lg-6 btn-group BTNmilieu">
                                    ...
                                    <div class="modal fade" id="PositionInconnueEcaflipus" tabindex="-1" role="dialog" aria-labelledby="PositionInconnueEcaflipusTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="" method="POST">
                                                        <button type="submit" class="btn btn-primary" name="inconnu-ecaflipus" value="<?php echo $ecaflipus['id_rubilax']; ?>" <?php if($session == 0){ echo 'disabled'; } ?>>Je suis sûr !</button>
                                                    </form>
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
                                                </div>
                                            </div>
